...
<div class="sermon-browser">
	...
	<h2 style="clear:both">Sermons [sermons_count before="(" after=")"]</h2>   	
	...
	[sermons_loop]	
		...
		<tr>
			<td class="sermon-passage">[passages] [series_link before="(Part of the " after=" series)." exclude="None,Misc,Miscellaneous"]</td>
		</tr>
		<tr>
		...
		<tr>
			<td class="preacher">Preached by [preacher_link] on [date] [service_link before="(" after=")"]. [editlink]</td>
		</tr>
   	[/sermons_loop]
	</table>
   	<div class="floatright">[next_page]</div>
...
<div class="sermon-browser-results">
	<h2>[sermon_title] <span class="scripture">[passages before="(" after=")"]</span> [editlink]</h2>
